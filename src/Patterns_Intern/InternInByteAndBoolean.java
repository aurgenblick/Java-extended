...
public class InternInByteAndBoolean {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Bytes got from valueOf(12) and new Byte(12) \nb1 = " + b1 + "\nb2 = " + b2 + "\nb1 == b2 : " + (b1 == b2));
        Byte b3 = Byte.valueOf((byte) 128);
        Byte b4 = new Byte((byte) 128);
        System.out.println("Bytes got from valueOf(128) and new Byte(128) \nb3 = " + b3 + "\nb4 = " + b4 + "\nb3 == b4 : " + (b3 == b4));
